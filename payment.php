...
<div class="span9">
	...
	<div class="row">
		...
		<div class="span5">
			<div class="well">
			<?php $min=1000000;$max=9999999;$rand=rand($min,$max); echo"<h5>Order Number : $rand</h5>";?>
			<form action="addProduct.php" method="POST" enctype="multipart/form-data">
			  <div class="control-group">
				<label class="control-label" for="Title">First Name* :</label>
				<div class="controls">
				  <input class="span4"  type="text" id="name" placeholder="First Name" name="fName">
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="Title">Last Name* :</label>
				<div class="controls">
				  <input class="span4"  type="text" id="name" placeholder="Last Name" name="lName">
				</div>
                </div>
				<div class="control-group">
				<label class="control-label" for="Title">Credit Card Number* :</label>
                <div class="controls">
                <input class="span4"  type="number" id="name" placeholder="Credit Card Number" name="CNumber">
                </div>
                </div>
                <div class="control-group">
				<label class="control-label" for="Title">Security Number* :</label>
                <div class="controls">
                <input class="span4"  type="number" id="name" placeholder="Security Number Ex:612" name="SNumber">
                </div>
                </div>
                <div class="control-group">
				<label class="control-label" for="Title">Expiration Date* :</label>
                <div class="controls">
                <input class="span4"  type="text" id="name" placeholder="Ex:11-2023" name="Expiration">
                </div>
                </div>
			  <div class="control-group">
				<div class="controls">
